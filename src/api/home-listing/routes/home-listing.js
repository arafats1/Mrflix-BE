module.exports = {
  routes: [
    ...
    { method: 'PUT', path: '/homes/listings/:id/status', handler: 'home-listing.setListingStatus', config: { auth: { scope: [] } } },
    { method: 'DELETE', path: '/homes/listings/:id', handler: 'home-listing.deleteListing', config: { auth: { scope: [] } } },
