...
const AUTHENTICATED_ACTIONS = [
  ...
  'api::home-listing.home-listing.requestPayout',
  'api::home-listing.home-listing.adminHomesHub',
  'api::home-listing.home-listing.adminMarkPayoutPaid',
  'api::home-listing.home-listing.adminRejectPayout',
  ...
  'api::car-loan-application.car-loan-application.sellerMine',
  'api::car-loan-application.car-loan-application.findMine',
  'api::car-loan-application.car-loan-application.choosePath',
  'api::car-loan-application.car-loan-application.payCrbFee',
  'api::car-loan-application.car-loan-application.runCreditCheck',
  'api::car-loan-application.car-loan-application.respondToOffer',
  'api::car-loan-application.car-loan-application.agreement',
  'api::car-loan-application.car-loan-application.uploadDocuments',
  'api::car-loan-application.car-loan-application.adminOverview',
  'api::car-loan-application.car-loan-application.updateStatus',
  'api::car-loan-application.car-loan-application.markDocumentsReady',
  'api::car-kyc.car-kyc.mine',
  'api::car-kyc.car-kyc.upsert',
  'api::car-kyc.car-kyc.adminList',
